...
import threading
import time
from ..common import AutonomousRunGate, RoutePreviewPublisher
from .control import ContinuousMotorConfig, path_drive_details
from .marker_counter import MarkerCounter, MarkerCounterConfig
from .planner import ContinuousPathConfig, ContinuousPathPlanner, PathIntent
...
class AutonomousRouteTracker:
    ...
    def _run(self) -> None:
        try:
            ...
            if str(track_src) not in sys.path:
