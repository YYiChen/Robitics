"""Scanline and hybrid visual perception without route state transitions."""
...
from .models import ScanlineConfig, ScanlineEvidence, ScanlineResult
...
# Keep this module hardware-free; route state transitions belong in planner.py.
