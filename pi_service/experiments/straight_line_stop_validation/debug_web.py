"""Small dependency-free browser preview for the isolated straight-line run."""
    ...
    def __init__(self, port: int) -> None:
        ...
        class Handler(BaseHTTPRequestHandler):
            ...
            def do_GET(self):  # noqa: N802
                ...
                if path == "/":
                    body = (
                        "<!doctype html><meta charset='utf-8'><title>Straight Line Stop</title>"
                        ...
                        "<main><h2>直行循线到终点停车</h2>"
                        "<p>只允许直行微调；连续丢线后锁定停车。</p>"
                        "<img src='/video_feed' alt='straight line debug stream'></main>"
                    ).encode("utf-8")
