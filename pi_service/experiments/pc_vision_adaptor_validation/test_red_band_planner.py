...
class TwoRedBandPlannerTests(unittest.TestCase):
    ...
    def test_turn_band_brakes_then_pivots(self):
        ...
        self.assertEqual(planner.update([layer(250, 265)], 640, 480).event, "BRAKE_NOW")
        self.assertEqual(planner.update([layer(390, 415)], 640, 480).event, "PIVOT_REQUEST")
    ...
    def test_exit_after_bottom_arming_reverses_if_pivot_was_missed(self):
        ...
        planner.update([layer(330, 350)], 640, 480)  # arm exit, but below pivot threshold
