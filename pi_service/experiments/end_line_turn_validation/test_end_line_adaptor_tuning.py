    ...
    def test_update_is_visible_immediate_and_persisted(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch.object(adaptor_module, "TURN_90_PATH", turn_90), patch.object(adaptor_module, "TURN_180_PATH", turn_180):
                ...
                status = tracker.update_tuning({"straight_pwm": 91, "turn_90_step_seconds": 1.4, "turn_interstep_pause_seconds": 1.5, "red_alignment_tolerance_degrees": 7, "red_alignment_overshoot_degrees": 4, "red_alignment_confirm_frames": 3, "turn_90_max_steps": 5, "correction_gain": 190})
                ...
                self.assertEqual(status["tuning"]["red_alignment_tolerance_degrees"], 7.0)
                self.assertEqual(status["tuning"]["red_alignment_overshoot_degrees"], 4.0)
